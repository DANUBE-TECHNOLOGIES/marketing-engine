...
class ContentBuilder {
  build(page, agency, site) {
    ...
    const factories = {
      ...
      "partners-introduction": () => ({ title: "Des partenaires reconnus", text: "Nous travaillons avec plusieurs tour-opérateurs, compagnies et réceptifs afin de comparer les solutions disponibles." }),
