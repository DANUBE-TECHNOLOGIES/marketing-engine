...
export default function LocalSeoCoverageClient() {
  ...
  return <main className="indexation-shell">
    <header className="indexation-hero"><div><p className="indexation-eyebrow">MSE-25.24 · Local SEO Coverage</p><h1>Couverture SEO locale</h1><p>Contrôle les signaux géographiques réellement présents dans les pages publiées : contenu, H1, NAP, données structurées locales et maillage interne. Une lacune produit une recommandation, jamais une page locale automatique.</p></div><div className="indexation-actions"><Link className="indexation-nav-link" href="/indexation/performance">Performance</Link><Link className="indexation-nav-link" href="/indexation">Cockpit</Link></div></header>
