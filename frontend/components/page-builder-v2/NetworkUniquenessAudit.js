  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      try {
        ...
        const page = site.pages.find((item) => String(item.slug || "") === String(pageSlug || ""));
