...
const rankingGrid = require("./ranking-grid");
...
const groupPreRegistration = require("./group-pre-registration");
...
module.exports = function registerModules(app, { prisma }) {
  ...
  if (rankingGrid.calibrationRoutes) app.use(rankingGrid.calibrationRoutes({ prisma }));
  if (rankingGrid.spatialRoutes) app.use(rankingGrid.spatialRoutes({ prisma }));
  ...
  if (groupPreRegistration.routes) app.use(groupPreRegistration.routes({ prisma }));
};