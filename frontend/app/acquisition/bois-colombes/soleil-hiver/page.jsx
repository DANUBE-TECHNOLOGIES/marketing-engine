...
function Brand({ light = false }) {
  return (
    <header style={S.brand}>
      <div style={{ ...S.logoPlate, ...(light ? S.logoPlateLight : {}) }}>
        <img src="/brand/logo-mondescale.png" alt="Mondescale Voyages" style={S.logoImage} />
      </div>
      <span style={{ ...S.brandLocation, color: light ? "rgba(255,255,255,.82)" : "#61736d" }}>BOIS-COLOMBES</span>
    </header>
  );
}
...
const S = {
  ...
  logoPlate: { display: "inline-flex", alignItems: "center", justifyContent: "center", background: "#fff", borderRadius: 12, padding: "8px 11px", boxShadow: "0 5px 20px rgba(23,59,52,.08)" },
  logoPlateLight: { background: "rgba(255,255,255,.96)", boxShadow: "0 8px 26px rgba(0,0,0,.12)" },
  logoImage: { display: "block", width: "clamp(150px,17vw,205px)", height: "auto", objectFit: "contain" },
  brandLocation: { fontSize: 10, letterSpacing: ".17em", fontWeight: 800 },
