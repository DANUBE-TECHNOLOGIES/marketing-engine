module.exports = {
  HOME: ["hero", "agency-introduction", "services-highlight", "destinations-highlight", "trust", "contact-cta"],
  ...
  REVIEWS: ["page-header", "reviews-introduction", "review-proof", "review-cta", "contact-cta"],
  CONTACT: ["page-header", "contact-details", "opening-contact", "map-placeholder", "contact-cta"],
  LEGAL: ["page-header", "legal-notice"],
  PRIVACY: ["page-header", "privacy-notice"]
};
