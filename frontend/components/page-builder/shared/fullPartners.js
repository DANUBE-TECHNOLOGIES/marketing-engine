...
export const FULL_PARTNERS = Object.freeze([
  ...
  P("rivages-du-monde", "Rivages du Monde", "croisieres", "Croisières culturelles haut de gamme, fluviales, maritimes et côtières, à bord de bateaux à taille humaine avec accompagnement francophone.", ["culture", "fluvial", "haut de gamme"], "/partners/rivages-du-monde.webp"),
  ...
  P("austral-lagons", "Austral Lagons", "sur-mesure", "Voyages dans les îles de l'océan Indien et du Pacifique, avec une forte expertise des séjours balnéaires long-courriers.", ["océan Indien", "Pacifique", "îles"], "/partners/austral-lagons.svg"),
