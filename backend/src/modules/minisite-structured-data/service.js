...
class MiniSiteStructuredDataService {
  ...
  async previewSitemap({ tenantId } = {}) {
    ...
    const technical = attachIndexationReadiness(auditSitemapCrawlability(applyInspirationIndexabilityContract(sitemap, sites, inspirations)));
