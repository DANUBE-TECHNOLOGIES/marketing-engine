...
Le plan de rollback est read-only. Il ne contient que les blocs explicitement créés par le rollout et nécessite une confirmation séparée dans une éventuelle couche d’exécution.
