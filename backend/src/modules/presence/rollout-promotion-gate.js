...
function compactAcknowledgementChainDiagnostic(decisionAcknowledgement){const audit=decisionAcknowledgement?.acknowledgementChainAudit||null;if(!audit)return null;return Object.freeze({ready:audit.ready===true,versioned:audit.versioned===true,rootSnapshotId:audit.rootSnapshotId||null,depth:Number(audit.depth||0),roots:Object.freeze([...(audit.roots||[])]),missingParents:Object.freeze([...(audit.missingParents||[])]),cycles:Object.freeze([...(audit.cycles||[])]),forks:Object.freeze([...(audit.forks||[])])});}
