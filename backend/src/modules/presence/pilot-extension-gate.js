...
async function evaluatePilotExtensionGate(prisma) {
  ...
  return Object.freeze({ready,decision:ready?"go":"no_go",blockers:Object.freeze([...new Set(blockers)]),warnings:Object.freeze(rollout.warnings||[]),canaryCampaignId:evidence.campaign.campaignId,reportId:evidence.frozen.id||null,reportCreatedAt:evidence.frozen.createdAt,rollout});
}
module.exports={isCanaryCampaign,recoveredCanaryStillValid,findLatestCompletedCanary,evaluatePilotExtensionGate};
