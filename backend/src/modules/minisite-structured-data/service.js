...
class MiniSiteStructuredDataService {
  ...
  health() { return { status: "ok", capability: "minisite-structured-data", persistence: false, destructive: false, deterministic: true, tenantScoped: true, publicGraphPublishedOnly: true, destinationSitemap: "localized-per-published-agency-site", editorialSitemap: "canonical-agency-only", inspirationIndexSitemap: "only-when-public-content-targets-agency", contentQualityIndexability: "critically-thin-nonfunctional-pages-excluded", crawlabilityAudit: "discovery-source-and-orphan-detection", indexationReadiness: "technical-local-seo-content-uniqueness-semantic-depth-and-search-intent-safe-to-submit-report", localSeoCoverage: "published-content-h1-nap-structured-data-linking-geographic-semantic-depth-and-search-intent-audit", localContentUniqueness: "cross-agency-published-homepage-similarity-audit", xmlSitemap: "network-and-site-candidate-rendering", publicOrigin: this.publicOrigin, schemas: ["TravelAgency", "LocalBusiness", "WebSite", "WebPage", "BreadcrumbList", "FAQPage"], operations: ["previewNetwork", "previewSitemap", "previewSite", "networkSitemapXml", "siteSitemapCandidate", "localSeoCoverage", "localContentUniqueness"] }; }
  ...
  async previewSitemap({ tenantId } = {}) {
    ...
    return attachLocalContentReadiness(intentReady, uniqueness);
  }
