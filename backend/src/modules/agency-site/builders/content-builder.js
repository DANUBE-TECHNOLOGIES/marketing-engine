...
class ContentBuilder {
  build(page, agency, site) {
    ...
    const factories = {
      ...
      "team-introduction": () => ({ title: "Des conseillers à votre écoute", text: `L’équipe de ${name} partage son expérience et ses conseils pour construire un voyage cohérent avec votre projet.` }),
      ...
      "partners-introduction": () => ({ title: `Des partenaires sélectionnés par votre agence à ${city}`, text: `${name} s’appuie sur un réseau de tour-opérateurs, croisiéristes et spécialistes pour comparer des solutions adaptées à votre projet. La présence d’une marque dans cet annuaire présente notre réseau de travail : votre conseiller reste votre interlocuteur pour vérifier les disponibilités, les conditions et la solution réellement pertinente pour votre voyage.` }),
      "partner-categories": () => ({ title: "Nos familles de partenaires", items: ["Tour-opérateurs généralistes", "Spécialistes destinations", "Compagnies de croisière", "Compagnies aériennes", "Assureurs voyage", "Réceptifs locaux"] }),
