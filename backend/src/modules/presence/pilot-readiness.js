...
function evaluateControlledPilot(input = {}, criteria = {}) {
  const deployment = input.deploymentReadiness || {};
  const deploymentPilot = deployment.pilot || {};
  ...
  if (!deploymentPilot.readyForGooglePilot) blockers.push("deployment_not_ready_for_google_pilot");
  ...
  if ((deploymentNetwork.googleListingCoveragePercent || 0) < minGoogleCoveragePercent) warnings.push("google_baseline_coverage_below_target");
  ...
  return Object.freeze({
    ...
    baseline: Object.freeze({ googleCoveragePercent: deploymentNetwork.googleListingCoveragePercent || 0, agencyCount: deploymentNetwork.agencyCount || 0, googleListings: deploymentNetwork.googleListingCount || 0 }),
...
module.exports = { evaluateControlledPilot };
