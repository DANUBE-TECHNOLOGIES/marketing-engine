...
module.exports = function createGoogleOAuthRoutes(prisma) {
  ...
  router.get([
    ...
    // A signed state belongs to another isolated Google provider (notably Search Console).
    // Let the next router validate and consume it instead of ever storing it as Google Business.
