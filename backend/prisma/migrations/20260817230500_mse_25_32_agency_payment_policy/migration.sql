...
CREATE UNIQUE INDEX "AgencyPaymentPolicy_siteId_key" ON "AgencyPaymentPolicy"("siteId");

ALTER TABLE "AgencyPaymentPolicy" ADD CONSTRAINT "AgencyPaymentPolicy_siteId_fkey" FOREIGN KEY ("siteId") REFERENCES "AgencySite"("id") ON DELETE CASCADE ON UPDATE CASCADE;
