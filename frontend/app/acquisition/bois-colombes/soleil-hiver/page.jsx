...
function Brand({ light = false }) {
  return <header style={S.brand}><div style={{ ...S.brandMark, ...(light ? S.brandMarkLight : {}) }}>M</div><div><strong style={{ ...S.brandName, color: light ? "#fff" : "#173b34" }}>MONDESCALE</strong><span style={{ ...S.brandSub, color: light ? "rgba(255,255,255,.72)" : "#6d7f79" }}>VOYAGES · BOIS-COLOMBES</span></div></header>;
}
...
const S = {
  ...
  brand: { display: "flex", alignItems: "center", gap: 12 }, brandMark: { width: 42, height: 42, borderRadius: "50%", display: "grid", placeItems: "center", background: "#173b34", color: "#fff", fontFamily: "Georgia,serif", fontSize: 24, fontStyle: "italic" }, brandMarkLight: { background: "rgba(255,255,255,.13)", border: "1px solid rgba(255,255,255,.38)" }, brandName: { display: "block", fontSize: 15, letterSpacing: ".16em" }, brandSub: { display: "block", fontSize: 9, letterSpacing: ".16em", marginTop: 3 },
